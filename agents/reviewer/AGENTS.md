...
3. Se aprovado:
   ...
   - Notificar no canal de SQUAD do Discord (Thread interna): `✅ PR #N mergeada — Issue #M concluída: <url>`
4. Se precisar de mudanças:
   - A skill se encarregará de solicitar as mudanças através do `gh` e alertar a issue como `blocked`.
   - Notificar no canal de SQUAD do Discord (Thread interna): `🔁 PR #N precisa de ajustes: <resumo>`
